...
namespace amurportal.Controllers
{
    public class AjaxController : Controller
    {
        ...
        public ActionResult GetDataValuesBySrok(int SiteId, string date_start, string date_end, int srokUTC)
        {
            Hydro.HydroService theHydro = new HydroService();
            
            DateTime utcDateBgn = DateTime.ParseExact(date_start + " 00:00:00", "dd.MM.yyyy H:mm:ss", new CultureInfo("en-US")).AddHours(srokUTC);
            DateTime utcDateEnd = DateTime.ParseExact(date_end + " 23:59:59", "dd.MM.yyyy H:mm:ss", new CultureInfo("en-US")).AddHours(-11);
